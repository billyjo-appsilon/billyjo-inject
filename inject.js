...
(function(){
  ...
  var DIRECT_HERO_BANNER_URL = directOfferAsset('images/direct-offer-top-banner-left-text.png');
  ...
  function injectStyles(){
    ...
    s.textContent =
      ...
      '@media(max-width:720px){#bj-do-back{align-items:flex-end;padding:0;background:rgba(10,16,30,.55)}#bj-do-box{max-width:none;max-height:92vh;border-radius:18px 18px 0 0}.bj-do-layout{display:block}.bj-do-main{padding:14px}.bj-do-side{padding:12px 14px 16px;border-left:0;border-top:1px solid #e2e8f7}#bj-do-head{min-height:124px;background-position:center center}.bj-do-card{grid-template-columns:58px minmax(0,1fr) 52px;gap:9px}.bj-do-card img{width:58px;height:58px}.bj-do-review{display:none}.bj-do-memo{min-height:96px}.bj-do-total-v{font-size:24px}#bj-do-jump{position:fixed;left:16px;right:16px;bottom:calc(env(safe-area-inset-bottom,0px) + 14px);z-index:100003;border:0;border-radius:12px;background:'+BLUE+';color:#fff;min-height:52px;padding:13px 16px;align-items:center;justify-content:center;gap:8px;font:950 15px/1.18 Pretendard,Arial,sans-serif;letter-spacing:0;box-shadow:0 14px 34px rgba(8,56,248,.34),0 0 0 1px rgba(255,255,255,.36);cursor:pointer}#bj-do-jump:after{content:"";width:18px;height:18px;flex:0 0 auto;background:url("data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2724%27 height=%2724%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27white%27 stroke-width=%273%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3E%3Cpath d=%27M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4%27/%3E%3Cpolyline points=%277 10 12 15 17 10%27/%3E%3Cline x1=%2712%27 y1=%2715%27 x2=%2712%27 y2=%273%27/%3E%3C/svg%3E") center/contain no-repeat}#bj-do-box.bj-do-jump-on #bj-do-jump{display:flex}}' +
