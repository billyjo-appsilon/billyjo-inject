  ...
  function reorderHome(pageEl) {
    ...
    if (!document.getElementById('bj-trust-partners-css')) {
      ...
      bjTrustCss.textContent =
        ...
        '.bj-trust-kicker{font-size:18px;line-height:1.25;font-weight:900;color:#1f2937;letter-spacing:0;margin:0 auto 5px;text-align:center}' +
