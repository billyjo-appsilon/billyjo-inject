...
(function(){
  ...
  function renderDisplayTotalHtml(){
    ...
    var couponHtml = coupon.active
      ? '<div class="bj-do-coupon-wrap"><div class="bj-do-coupon-card" role="img" aria-label="1주일에 한번 오늘만 30,000포인트 추가 쿠폰"><i aria-hidden="true"></i><div class="bj-do-coupon-copy"><span>1주일에 한번! 오늘만</span><em>추가 쿠폰</em></div><b class="bj-do-coupon-amount">30,000p</b></div><span class="bj-do-coupon-time">쿠폰 유효시간 <b data-bj-do-coupon-left>' + esc(couponCountdownText(coupon)) + '</b> · 7일 1회 한정</span></div>'
      : '';
  ...
  function makeMemo(){
    ...
    var lines = [
      ...
      'AI 예상 지원금 합계: ' + won(displayTotalRange().low) + ' ~ ' + won(displayTotalRange().high) + ' + 30,000원 쿠폰'
    ];
      ...
      '<div id="bj-do-body">' +
        '<div class="bj-do-layout">' +
          ...
          '<div class="bj-do-side">' +
            '<div id="bj-do-total"><div class="bj-do-total-k">AI 예상 지원금 합계</div><div class="bj-do-total-v is-calculating">계산 중입니다</div><div class="bj-do-total-sub">지원금 합계금을 계산 중입니다.</div></div>' +
            '<textarea class="bj-do-memo" readonly></textarea>' +
            '<button type="button" class="bj-do-copy">3초 견적 시작</button>' +
            '<div class="bj-do-note">선택 상품은 견적비교함에 담긴 뒤 24시간 견적 인증/신청 단계로 이동합니다.</div>' +
          '</div>' +
        '</div>' +
      '</div>' +
      '<button type="button" id="bj-do-jump">3초 견적 시작 보기</button>';
