  ...
  (function initBottomBar() {
    var bbInterval = setInterval(function() {
      ...
      monthBoxes.forEach(function(mb, idx) {
        ...
        var show = sup === suppliers[0] ? '' : ' style="display:none"';
        monthPillsHtml +=
          '<div class="bb-month-pill" data-idx="' + idx + '" data-month-key="' + monthKey + '" data-sup="' + sup + '"' + show + '>' +
      ...
      bar.querySelectorAll('.bb-sup-tab').forEach(function(tab) {
        tab.addEventListener('click', function() {
          ...
          bbPills.forEach(function(p) {
            p.style.display = p.getAttribute('data-sup') === activeSup ? '' : 'none';
