...
(function(){
  ...
  function renderDisplayTotalHtml(){
    ...
    var couponHtml = coupon.active
      ? '<div class="bj-do-coupon-card" role="img" aria-label="1주일에 한번 오늘만 30,000포인트 추가 쿠폰"><div class="bj-do-coupon-copy"><span>1주일에 한번! 오늘만</span><em>추가 쿠폰</em></div><b class="bj-do-coupon-amount">30,000p</b></div>'
      : '';
