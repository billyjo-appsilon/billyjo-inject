  ...
  function reorderHome(pageEl) {
    ...
    if (!document.getElementById('bj-trust-partners-css')) {
      ...
      bjTrustCss.textContent =
        ...
        '.bj-trust-partners{display:flex;align-items:center;justify-content:center;gap:10px;flex-wrap:nowrap;margin:16px auto 0;max-width:330px}' +
