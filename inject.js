...
(function(){
  ...
  function openModal(proceed, opts){
      ...
      '<div id="bj-do-body">' +
        '<div class="bj-do-layout">' +
          ...
          '<div class="bj-do-side">' +
            ...
            '<button type="button" class="bj-do-copy">지원금 쿠폰 받기</button>' +
            '<div class="bj-do-note">선택 상품은 견적비교함에 담긴 뒤 24시간 견적 인증/신청 단계로 이동합니다.</div>' +
          '</div>' +
        '</div>' +
      '</div>' +
      '<button type="button" id="bj-do-jump">지원금 쿠폰 받기 보기</button>';
    ...
    box.querySelector('.bj-do-copy').onclick = function(){
      ...
      setTimeout(function(){ var b = box.querySelector('.bj-do-copy'); if (b) b.textContent = '지원금 쿠폰 받기'; }, 1400);
    };
