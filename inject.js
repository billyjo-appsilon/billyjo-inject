...
function bjHeaderMainInit() {
  ...
  if (location.pathname.indexOf('prod_list') !== -1) {
    ...
    var bjpFormat = function(item) {
      ...
      if (hasDisc) {
        box.innerHTML =
          '<div class="bj-pz-top"><span class="bj-pz-lbl">제휴카드가</span>' +
          '<span class="bj-pz-orig">' + bjpFmt(reg) + '원</span></div>' +
          '<div class="bj-pz-now">' + bjpFmt(card) +
          '<span class="bj-pz-won">원</span><span class="bj-pz-per">/월</span></div>' +
          '<div class="bj-pz-save">제휴카드 <b>-' + bjpFmt(reg - card) + '원</b></div>';
      } else {
        box.innerHTML =
          '<div class="bj-pz-top"><span class="bj-pz-lbl">월 렌탈료</span></div>' +
          '<div class="bj-pz-now bj-pz-single">' + bjpFmt(reg) +
          '<span class="bj-pz-won">원</span><span class="bj-pz-per">/월</span></div>' +
          '<div class="bj-pz-save bj-pz-ph">제휴카드 <b>-0원</b></div>';
      }
      var anc = fee2 || fee;
