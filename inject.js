...
(function(){
  ...
  function renderDisplayTotalHtml(){
    ...
    var couponHtml = coupon.active
      ? '<span class="bj-do-secret">+ 30,000원 쿠폰</span><span class="bj-do-coupon-time">남은시간: <b data-bj-do-coupon-left>' + esc(couponCountdownText(coupon)) + '</b> · 동일 IP 기준 주 1회</span>'
      : '<span class="bj-do-coupon-expired">이번 주 30,000원 쿠폰은 이미 확인된 조건입니다.</span>';
  ...
  function totalRangeText(){
    var range = displayTotalRange();
    return '지원금 합계금은 최종표기금액의 85% ~ 최종표기금액 구간입니다. 실제 지급액은 상담 후 확정됩니다.';
  }
