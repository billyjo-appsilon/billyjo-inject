...
function bjHeaderMainInit() {
  ...
  if (location.pathname.indexOf('prod_list') !== -1) {
    ...
    var bjpFormat = function(item) {
      ...
      if (hasDisc) {
        box.innerHTML =
          '<div class="bj-pz-top"><span class="bj-pz-lbl">정상가</span>' +
          '<span class="bj-pz-orig">' + bjpFmt(reg) + '원</span></div>' +
          '<div class="bj-pz-cap">제휴카드가</div>' +
        ...
        box.innerHTML =
          ...
          '<span class="bj-pz-won">원</span><span class="bj-pz-per">/월</span></div>' +
          '<div class="bj-pz-cap bj-pz-ph">제휴카드가</div>' +
