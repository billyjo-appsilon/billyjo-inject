...
(function(){
  ...
  function injectStyles(){
    ...
    s.textContent =
      ...
      '#bj-do-head{padding:0;width:100%;aspect-ratio:1280/269;min-height:0;background:#0838f8 url("'+DIRECT_HERO_BANNER_DESKTOP_URL+'") center/contain no-repeat;position:relative;color:#fff;overflow:hidden;flex:0 0 auto}.bj-do-badge{display:none}.bj-do-h{position:absolute!important;width:1px!important;height:1px!important;padding:0!important;margin:-1px!important;overflow:hidden!important;clip:rect(0,0,0,0)!important;white-space:nowrap!important;border:0!important}.bj-do-h-sub{display:inline-block;font-size:calc(1em - 1px);font-weight:900;margin-left:2px}.bj-do-sub{display:none}.bj-do-x{position:absolute;right:10px;top:10px;width:26px;height:26px;border:0;background:rgba(255,255,255,.92);color:'+BLUE+';font-size:17px;line-height:24px;border-radius:50%;cursor:pointer;box-shadow:0 3px 10px rgba(15,32,70,.14);padding:0}' +
